import {education} from "../data/portfolio.json";
...
const Education = () => {
  return (
    ...
    >
      ...
      >
        <span className="inline-block bg-primary text-typo px-3 py-1 border-4 border-black shadow-[4px_4px_0_0_rgba(0,0,0,1)] rounded-none">
          Education
        </span>
      </motion.h2>
      ...
      <div className="space-y-8">
        {education.map((edu, index) => (
          ...
          >
            <div className="absolute -left-[13px] top-1 w-5 h-5 bg-primary border-2 border-black rounded-full shadow-[2px_2px_0_rgba(0,0,0,1)]"></div>
            <h3 className="text-xl sm:text-2xl font-bold">{edu.university}</h3>
