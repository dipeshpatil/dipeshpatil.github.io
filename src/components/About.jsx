...
const About = () => {
  return (
    <section
      id="about"
      className="p-4 relative w-full mx-auto px-4 sm:px-8 md:px-10 py-10 bg-secondary text-black border-4 border-black rounded-none shadow-[8px_8px_0_0_rgba(0,0,0,1)] overflow-hidden mt-4"
    >
